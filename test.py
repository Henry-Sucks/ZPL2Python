...
grammar_path = '/home/ZPL2Python/src/grammer.lark'
include_path = '/home/ZPL2Python/mylib/include/mylib.h'

transformer = TestTransformer()
loader = FunctionLoader(config_path, grammar_path, transformer, include_path)
loader.load_config()
loader.add_bindings()
loader.add_grammar()
...
# 如果调用了外部函数，在开头import
if loader.has_not_built_ins:
    import_code = f'from {loader.get_module_name()} import {loader.get_import_not_built_ins_list()}\n'
